...
$string['wordle_help'] = 'Check this option if you want the player to have to guess SINGLE words instead of sentences. Use only UPPERCASE LETTERS (A-Z) and no accents.';
