...
$string['wordle_help'] = 'Check this option if you want the player to have to guess single words instead of sentences. Use only CAPITAL LETTERS and no accents.';
