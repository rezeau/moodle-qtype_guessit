...
/**
 * guessit question type restoration
 *
...
class restore_qtype_guessit_plugin extends restore_qtype_plugin {
    ...
    public function process_gapsetting($data) {
        ...
        if ($questioncreated) {
            ...
            $data->question = $newquestionid;
            // Insert record.
            $newitemid = $DB->insert_record('question_guessit_settings', $data);
            // Create mapping (needed for decoding links).
            $this->set_mapping('question_guessit_settings', $oldid, $newitemid);
        }
     ...
     * http://docs.moodle.org/en//question/type/guessit#No_Duplicates_Mode
